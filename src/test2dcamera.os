...
Процедура Инициализация()
    ...
    screenHeight = 450;
    MAX_BUILDINGS = 20;
    рейлиб.ИнициализацияОкна("2D камера", screenWidth, screenHeight);
...
Процедура Отрисовка()
    ...
    // UI
    рейлиб.НарисоватьТекст("2D камера controls:", 20, 20, 10, рейлиб.НовыйЦвет(0, 0, 0, 255));
    рейлиб.НарисоватьТекст("- Right/Left: move player", 40, 40, 10, рейлиб.НовыйЦвет(64, 64, 64, 255));
    рейлиб.НарисоватьТекст("- Mouse Wheel: Zoom", 40, 60, 10, рейлиб.НовыйЦвет(64, 64, 64, 255));
    рейлиб.НарисоватьТекст("- A/S: Rotate", 40, 80, 10, рейлиб.НовыйЦвет(64, 64, 64, 255));
    рейлиб.НарисоватьТекст("- R: Reset", 40, 100, 10, рейлиб.НовыйЦвет(64, 64, 64, 255));
